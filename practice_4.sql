...
where isyeri         --baglantı noktası
in(select marka_isim from markalar where calisan_sayisi>15000)  ---iki sorguyu in ile birlestirdik
--in kullanacaksak parantez icine aldıgımız sorgu birden fazla deger dondurmelidir
