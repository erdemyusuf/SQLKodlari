...
(                                                                                             
id serial primary key  ,    --serial  id yi otomatik artırır                                                                 
isim varchar(20),                                                                             
yas int,                                                                                      
maas int,                                                                                     
email varchar(30)                                                                             
...
select*from personel where isim ilike 'A%';  --- % isareti ne ile devam ederse etsin anlamında
...
select*from personel where email ~* '@gmail' --regex ile yapılmıs hali
...
select *from personel where id in(3,5,7,9);  -- aynı degiskene sahip verileri in icine yazarız
...
select*from personel order by yas;-- dogal sıralama kucukten buyugedir
